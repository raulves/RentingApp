...
{
    public class ProductDescriptionCreateEditViewModel : IDomainEntityId
    {
        ...
        [Display(Name = nameof(Description), ResourceType = typeof(Resources.Domain.ProductDescription.ProductDescription))]
