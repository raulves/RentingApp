...
namespace Domain.App
{
    public class LangStr : DomainEntityIdMetadata
    {
        ...
        [InverseProperty(nameof(PaymentType.Description))]
        public ICollection<PaymentType>? PaymentTypeDescriptions { get; set; }
        
        [InverseProperty(nameof(Category.Description))]
        public ICollection<Category>? CategoryDescriptions { get; set; }
        
        [InverseProperty(nameof(ProductDescription.Description))]
